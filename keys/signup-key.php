                ...
                if ($resultado->num_rows == 0) {
                    ...
                    if ($resultado->num_rows == 0) {
                        if ($password == $passconf) {
                            $INSERT = "INSERT INTO registro (nombre,apellido,nom_comp,numero,usuario,email,password,birthday,genero,foto,portada,presentacion,status,date_signup)values('$nombre','$apellido','$nom_comp','$numero','$usuario','$email','$script_password','$birthday','$genero','$foto','$portada','$presentacion','$status',NOW())";
