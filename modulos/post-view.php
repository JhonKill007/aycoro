<div class="conteiner">
    ...
    <div class="container-scroll">
        ...
        if ($eso) {
            ...
            $SELECT = "SELECT * from folow inner join post on folow.id_folowing = post.owner inner join registro on post.owner=registro.id_registro where folow.id_folower='$id' ORDER BY rand() DESC LIMIT 12";
