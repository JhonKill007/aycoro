<form action="" method="post" class="formstatuspost">
    ...
    <input type="hidden" value="" name="estado_post" id="estado_post_post">
    <!-- <textarea class="form-control col-sm-12" name="estado_post" id="estado_post" cols="20" rows="2" maxlength="115" required></textarea> -->
            ...
            .then((result) => {
                if (result.isConfirmed) {
                    ...
                    if (string == "") {
                        ...
                        document.getElementById("estado_post_post").value = string;
                        ...
                        let formDatast<?php echo $registro['id_registro']; ?> = new FormData(formu<?php echo $registro['id_registro']; ?>); 
                        xhrst<?php echo $registro['id_registro']; ?>.send(formDatast<?php echo $registro['id_registro']; ?>); 
                    }
                }
            })
    }
